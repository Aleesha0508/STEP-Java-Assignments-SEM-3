...
public class SmartDevice {
    ...
    public static void main(String[] args) {
        ...
        SmartDevice device1 = new SmartDevice("Smart Light", "Living Room", false, 12.5);
        SmartDevice device2 = new SmartDevice("Thermostat", "Bedroom", true, 5.0);

        // Method chaining
        device1.setOnline(true).connectToDevice("Alexa").rename("Hallway Light");
        device2.connectToDevice("Smart Light").updateLocation("Master Bedroom");
