...
public class AudioMixer {
    ...
    public AudioMixer(String mixerModel, int numberOfChannels,
        ...
        this.deviceCount = 0;
        System.out.println("AudioMixer Constructor: Created " + mixerModel);
    }
    ...
    public static void main(String[] args) {
        ...
        AudioMixer m3 = new AudioMixer("BT-Mix", 12, true);
        AudioMixer m4 = new AudioMixer("UltraMix-24", 24, true, 150.0);
